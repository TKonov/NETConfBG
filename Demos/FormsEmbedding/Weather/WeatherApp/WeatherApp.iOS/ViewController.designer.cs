...
namespace WeatherApp.iOS
{
	...
	partial class ViewController
	{
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UITextField cityNameEntry { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UILabel cityNameLabel { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UILabel cityNameSearchLabl { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (cityNameSearchLabl != null) {
                cityNameSearchLabl.Dispose ();
                cityNameSearchLabl = null;
			}
		}
	}
}
